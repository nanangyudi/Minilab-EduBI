...
SELECT
    ...
    toInt32OrZero(toString(rating))                         AS rating,
    ...
    CASE
        WHEN toInt32OrZero(toString(rating)) >= 4 THEN 'Positif'
        WHEN toInt32OrZero(toString(rating)) = 3  THEN 'Netral'
        ELSE 'Negatif'
    END AS sentiment
...
WHERE
    ...
    AND toInt32OrZero(toString(rating)) BETWEEN 1 AND 5
